...
public class TunnelMachineFilters {
    ...
    public static ITunnelFilter all(GlobalPos machine) {
        return (graph, tunnel) -> GraphTraversalHelper.successors(graph.graph(), tunnel, CompactMachineNode.class)
    ...
    public static ITunnelFilter sided(GlobalPos machine, Direction side) {
        return (graph, tunnel) -> GraphTraversalHelper.edges(graph.graph(), tunnel, TunnelMachineEdge.class, CompactMachineNode.class)
